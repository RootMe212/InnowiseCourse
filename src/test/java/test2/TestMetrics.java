 ...
 * most popular product by sales Average check for successfully delivered orders Customers who have
 * more than 5 orders
 */
class TestMetrics {
  ...
  @BeforeEach
  void setUp() {
    Customer customer1 = new Customer("1", "Kirill", "kiril@gmail.com", LocalDateTime.now(), 20,
        "Minsk");
    Customer customer2 = new Customer("2", "John", "John@gmail.com", LocalDateTime.now(), 22,
        "Brest");
    Customer customer3 = new Customer("3", "Bob", "bob@gmail.com", LocalDateTime.now(), 21,
        "Minsk");
    ...
    Order order1 = new Order("O1", LocalDateTime.now(), customer1, List.of(item1),
        OrderStatus.DELIVERED);
    Order order2 = new Order("O2", LocalDateTime.now(), customer2, List.of(item3),
        OrderStatus.DELIVERED);
    Order order3 = new Order("O3", LocalDateTime.now(), customer3, List.of(item4),
        OrderStatus.DELIVERED);
    Order order4 = new Order("O4", LocalDateTime.now(), customer1, List.of(item2),
        OrderStatus.CANCELLED);
    Order order5 = new Order("O5", LocalDateTime.now(), customer1, List.of(item4),
        OrderStatus.PROCESSING);
    Order order6 = new Order("O6", LocalDateTime.now(), customer1, List.of(item4),
        OrderStatus.SHIPPED);
    Order order7 = new Order("O7", LocalDateTime.now(), customer1, List.of(item4), OrderStatus.NEW);
    Order order8 = new Order("O8", LocalDateTime.now(), customer1, List.of(item4),
        OrderStatus.DELIVERED);
